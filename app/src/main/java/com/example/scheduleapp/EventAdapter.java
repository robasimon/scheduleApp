...
class EventAdapter extends BaseAdapter {
    ...
    public EventAdapter(Activity context, GregorianCalendar monthCalendar, ArrayList<HomeCollection> date_collection_arr) {
    ...
    public void getPositionList(String date,final Activity act){
        ...
        if (jbarrays.length()!=0) {
            ...
            listTeachers.setAdapter(new DialogAdapter(context, getMatchList(jbarrays + "")));
