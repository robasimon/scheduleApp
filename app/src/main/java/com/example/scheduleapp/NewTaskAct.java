...
public class NewTaskAct extends AppCompatActivity implements DatePickerDialog.OnDateSetListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CollectionReference employeeRef = mRef.collection("users").document(FirebaseAuth.getInstance().getCurrentUser().getEmail()).collection("employees");
        employeeRef.get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
            ...
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                if(task.isSuccessful()){
                    ...
                    @SuppressLint("RestrictedApi") ArrayAdapter<String> adapter = new ArrayAdapter<String>(getApplicationContext(), android.R.layout.simple_spinner_item, emp2);
        ...
        startTime.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                timepickerdialog = new TimePickerDialog(NewTaskAct.this, android.R.style.Theme_Holo_Light_Dialog, new TimePickerDialog.OnTimeSetListener() {
                String temp,temp2;
                    @Override
        ...
        btnSaveTask.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                reference = FirebaseDatabase.getInstance().getReference().child("shifts").
                     child(date).child(spinner.getSelectedItem().toString());
